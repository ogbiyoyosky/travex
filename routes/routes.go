...
func SetupRoutes(app *fiber.App) {
	...
	app.Post("/api/locations", dto.CreateLocationValidator, middleware.ValidateJwt, controller.AddLocation)
	app.Post("/api/masteradmin/locations", dto.CreateMasterValidator, middleware.ValidateJwt, controller.AddMasterAdminLocation)
